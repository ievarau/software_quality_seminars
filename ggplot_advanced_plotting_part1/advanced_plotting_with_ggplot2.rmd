...
We will need a few files and parameters. They are defined bellow:
...
```{r plotting_conservation, eval = TRUE, echo = TRUE, include = TRUE, cache = TRUE, fig.cap = "**Figure 1A. Conservation plot**", fig.align = "center", fig.height = 6, fig.width = 7, warning = FALSE}
...
We will draw our motif logos from the matrices (read above). These individual plots will be then used to insert on the conservation track plots.
...
```{r adding_motifs, eval = TRUE, echo = TRUE, include = TRUE, cache = TRUE, fig.cap = "**Figure 4. Conservation plot with visualized motifs and their locations**", fig.align = "center", fig.height = 6, fig.width = 7}

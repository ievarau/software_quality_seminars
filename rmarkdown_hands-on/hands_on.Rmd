...
<div align = "justify">
RMarkdown is a very useful thing to learn and it can help you:

- make a nice report on your analysis;
- create a reproducible workflow;
- make a tutorial (just like this one);
- make organized notes when executing code.

In this document I will not list all the syntax or other functionalities of RMarkdown, because this was already covered or there are plenty of recourses online (see bolow). Here we will try to write and execute code.
</div>

<p>&nbsp;</p>

```{r how_to_render, eval = FALSE, echo = TRUE}
rmarkdown::render(
    "/home/ievarau/Documents/phd/software_quality_seminars/rmarkdown_hands-on/hands_on.Rmd",
    output_format = "html_document")
# rmarkdown::render("input.Rmd", html_document(toc = TRUE, toc_depth = 2))
```

## RMarkdown cheatsheet

RStudio (or now Posit) offers a collection of [**cheatsheets**](https://posit.co/resources/cheatsheets/) that I highly recommend. One of them is for [**RMarkdown**](https://rstudio.github.io/cheatsheets/html/rmarkdown.html).

## Other recources

Basic RMarkdown syntax was covered in Software quality session. There are some recources available.

- [this GIT repo](https://github.com/ievarau/software_quality_seminars/tree/main/rmarkdown) with the template document, examples and explanations. It has it's accompanying SoftFlix [episode](https://drive.google.com/drive/folders/1OvV3Ajw39mYW30ZIeHJmCSfUDk_sPFfy)
- Some other topics were covered using RMarkdown. For example [more advanced ggplot2 plotting session](https://github.com/ievarau/software_quality_seminars/tree/main/ggplot_advanced_plotting_part1).
...
You can run bash chunks in here. Make sure you have that `engine.opts='-l'` parameter.

```{bash get_files, engine.opts='-l', eval = FALSE, echo = FALSE, include = FALSE}
mkdir -p example_data ;

wget -O example_data/CTCF_conservation.tsv https://raw.githubusercontent.com/ievarau/software_quality_seminars/main/ggplot_advanced_plotting_part1/conservation_plot/CTCF_conservation.tsv
wget -O example_data/CTCF_conservation_random.tsv https://raw.githubusercontent.com/ievarau/software_quality_seminars/main/ggplot_advanced_plotting_part1/conservation_plot/CTCF_conservation_random.tsv

wget -O example_data/cobinder_0.txt https://raw.githubusercontent.com/ievarau/software_quality_seminars/main/ggplot_advanced_plotting_part1/conservation_plot/cobinder_0.txt
wget -O example_data/core_0.txt https://raw.githubusercontent.com/ievarau/software_quality_seminars/main/ggplot_advanced_plotting_part1/conservation_plot/core_0.txt
...
## Conservation files:
cons_file        <- "example_data/CTCF_conservation.tsv"
random_cons_file <- "example_data/CTCF_conservation_random.tsv"

## Motifs:
cobinder_file <- "example_data/cobinder_0.txt"
core_file     <- "example_data/core_0.txt"
...
# Importing and displaying results from other places

We will try to import a plot as an R object and then display it in our report.

```{r show_plots, eval = TRUE, echo = TRUE, include = TRUE, cache = TRUE, fig.cap = "**Figure 5. Spacings plot for SOX17**", fig.align = "center", fig.height = 10, fig.width = 20, out.width = "150%", warning = FALSE}

path_to_example_plot <- "example_data/example_plot.RData"

spacings_plot <- get(load(path_to_example_plot))

path_to_example_plot <- "example_data/example_plot.png"

knitr::include_graphics(path_to_example_plot, dpi = 1200)
...
<div align = "center">
![**Figure 6. Spacings plot for SOX17**. Loaded from PDF](example_data/example_plot.pdf){width=100% height=400}
</div>
